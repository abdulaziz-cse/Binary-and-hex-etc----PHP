<html lang="en">
 ...
 $binNumeric1 = intval($number1,2);
 $decString1 = strval($binNumeric1);
                                    ...
                                    <div class="col-md-12 content-page">
                                      <div class="col-md-12 blog-post">
                                        <div class="row margin-top-30">
                                          ...
                                          <div class="row">
                                           <form action="bintodec.php" method="POST">

        					                <div class="col-sm-6">
        						              <div class="form-group">
        						               <input type="text" name="number1" class="form-control" placeholder="Number Binary">
        						              </div>
                                             </div>
                                            ...
                                            <div class="col-sm-6">
        					                  <div class="form-group">
                                       <div class="col-sm-6">
                                      Rusulte<p class="form-control-static"><?php echo $decString1;?></p>
                                              </div>
        						                           </div>
                                            </div>
