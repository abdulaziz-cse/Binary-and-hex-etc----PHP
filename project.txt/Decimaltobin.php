    ...
    <div id="main">
        <div class="container">
            <div class="row">
                            ...
                            <div class="col-md-12 content-page">
                              <div class="col-md-12 blog-post">
                                <div class="row margin-top-30">
                                  ...
                                  <div class="row">
                                   <form action="Decimaltobin.php" method="POST">
       		...
       		<tr>
            <td><?php echo $number /2?>/2</td>
            <td><?php echo $quotient /2 ?></td>
            <td><?php echo $remainder /2  % 2?></td>
       		</tr>
       		<tr>
            <td><?php echo $number /4 ?>/2</td>
            <td><?php echo $quotient /4 ?></td>
            <td><?php echo  $number  % 2?></td>

       		</tr>
       		<tr>
            <td><?php echo $number /6 ?>/2</td>
            <td><?php echo $quotient /6 ?></td>
            <td><?php echo  $number  % 2?></td>
       		</tr>
       	</tbody>
      </table>
