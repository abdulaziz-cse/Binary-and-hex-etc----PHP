...
<html lang="en">
 ...
 <body>
   ...
   <?php
    ...
    $octString = base_convert($decString,10,8);
                            ...
                            <div class="col-md-12 content-page">
                              <div class="col-md-12 blog-post">
                                <div class="row margin-top-30">
                                  ...
                                  <div class="row">
                                   <form action="decimaltooctal.php" method="POST">
                                    ...
                                    <div class="col-sm-6">
					                  <div class="form-group">
					                 <textarea class="textarea-message form-control" placeholder="Your Binary" rows="6"><?php echo "$octString"; ?></textarea>
						            </div>
                                   </div>
